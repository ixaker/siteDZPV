...
const CustomButton: FC<PropsCustomButton> = ({
  ...
  const buttonClass = {
    ...
    'send-btn':
      'shadow-[0_10px_30px_#000] bg-[#c43c1e] text-[#f9f7dc] text-[13px] md:text-[18px] px-6 py-3  sm:py-3 rounded-[10px] hover:bg-[#9e2a1f] hover:text-[#fff] transition-all duration-300 ease-in-out',
  }[variant];
